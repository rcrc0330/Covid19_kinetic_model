...
k1 = p(4);      % rate constant of Recovery
k2 = p(3)/p(1); % rate constant of Infection Spreading, symptomatic
k2p = k2;       % rate constant of Infection Spreading, asymptomatic
%Testing rate data
k3 = 0.9*p(2)*t^0.5*IHS; % rate of testing and identifying symptomatic

k3p = 0.1*p(2)*t^0.5*IHA; % rate of testing and identifying asymptomatic
